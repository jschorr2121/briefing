...
const CURATED_TOPICS = new Map<string, TopicConfig>([
  ...
  ['artificial_intelligence', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'artificial intelligence AI',
    perigonTopic: 'AI', perigonCategory: 'Tech', category: 'Technology',
  }],
  ['cybersecurity', {
    id: 'cybersecurity', displayName: 'Cybersecurity',
    type: 'niche', queryStrategy: 'both', keywordQuery: 'cybersecurity data breach hacking',
  ...
  ['cloud_computing', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'cloud computing AWS Azure Google Cloud',
  ...
  ['startups_vc', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'startup funding venture capital',
  ...
  ['cryptocurrency', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'cryptocurrency bitcoin ethereum',
  ...
  ['software_engineering', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'software engineering programming developer tools',
  ...
  ['consumer_tech', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'consumer technology gadgets',
  ...
  ['semiconductors', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'semiconductor chip manufacturing',
  ...
  ['stock_market', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'stock market Wall Street S&P 500',
  ...
  ['financial_services', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'financial services fintech banking',
  ...
  ['real_estate', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'real estate housing market mortgage',
    perigonTopic: 'Real Estate', perigonCategory: 'Finance', category: 'Business & Finance',
  }],
  ['economy', {
    id: 'economy', displayName: 'Economy',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'economy GDP inflation Federal Reserve',
    perigonTopic: 'Economy', perigonCategory: 'Finance', category: 'Business & Finance',
  }],
  ['banking', {
    id: 'banking', displayName: 'Banking',
    type: 'niche', queryStrategy: 'both', keywordQuery: 'banking banks financial regulation',
  ...
  ['mergers_acquisitions', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'mergers acquisitions M&A deals',
  ...
  ['nfl', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'NFL football',
    perigonTopic: 'NFL', perigonCategory: 'Sports', category: 'Sports',
  }],
  ['nba', {
    id: 'nba', displayName: 'NBA',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'NBA basketball',
    perigonTopic: 'NBA', perigonCategory: 'Sports', category: 'Sports',
  }],
  ['pga_tour', {
    id: 'pga_tour', displayName: 'PGA Tour',
    type: 'niche', queryStrategy: 'both', keywordQuery: 'PGA Tour golf tournament',
  ...
  ['ufc_mma', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'UFC MMA mixed martial arts',
    perigonTopic: 'UFC', perigonCategory: 'Sports', category: 'Sports',
  }],
  ['formula_1', {
    id: 'formula_1', displayName: 'Formula 1',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'Formula 1 F1 Grand Prix racing',
    perigonTopic: 'Formula 1', perigonCategory: 'Sports', category: 'Sports',
  }],
  ['college_football', {
    id: 'college_football', displayName: 'College Football',
    type: 'niche', queryStrategy: 'both', keywordQuery: 'college football NCAA CFP',
  ...
  ['premier_league', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'Premier League soccer football EPL',
    perigonTopic: 'Soccer', perigonCategory: 'Sports', category: 'Sports',
  }],
  ['mlb', {
    id: 'mlb', displayName: 'MLB',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'MLB baseball',
    perigonTopic: 'MLB', perigonCategory: 'Sports', category: 'Sports',
  }],
  ['tennis', {
    id: 'tennis', displayName: 'Tennis',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'tennis ATP WTA Grand Slam',
    perigonTopic: 'Tennis', perigonCategory: 'Sports', category: 'Sports',
  }],
  ['golf', {
    id: 'golf', displayName: 'Golf',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'golf PGA LPGA major championship',
  ...
  ['space_astronomy', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'space NASA astronomy SpaceX',
    perigonTopic: 'Space', perigonCategory: 'Science', category: 'Science',
  }],
  ['climate_environment', {
    id: 'climate_environment', displayName: 'Climate & Environment',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'climate change environment sustainability',
    perigonTopic: 'Climate Change', perigonCategory: 'Science', category: 'Science',
  }],
  ['biotech_pharma', {
    id: 'biotech_pharma', displayName: 'Biotech & Pharma',
    type: 'niche', queryStrategy: 'both', keywordQuery: 'biotech pharmaceutical drug development',
  ...
  ['physics_energy', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'physics energy nuclear fusion',
  ...
  ['us_politics', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'US politics Congress White House',
  ...
  ['world_news', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'world news international',
  ...
  ['supreme_court', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'Supreme Court SCOTUS ruling',
  ...
  ['geopolitics', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'geopolitics international relations diplomacy',
  ...
  ['defense_military', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'defense military Pentagon',
  ...
  ['travel', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'travel tourism airlines destinations',
  ...
  ['food_dining', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'food dining restaurants',
  ...
  ['personal_finance', {
    ...
    type: 'niche', queryStrategy: 'both', keywordQuery: 'personal finance investing savings retirement',
  ...
  ['health_fitness', {
    ...
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'health fitness wellness',
    perigonTopic: 'Fitness', perigonCategory: 'Lifestyle', category: 'Lifestyle',
  }],
  ['parenting', {
    id: 'parenting', displayName: 'Parenting',
    type: 'broad', queryStrategy: 'articles', keywordQuery: 'parenting children family',
